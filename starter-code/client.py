...
def arg_parser():
    ...
    parser.add_argument(
        "nodes", type=str, nargs="+", help="addresses (host:port) of nodes to test"
    )
...
def simple_check(nodes):
    ...
    for key, value in pairs.items():
        ...
        if status in range(200, 300) and returned == value:
            ...
            print(
                "PUT/GET to {}: UNEXPECTED CONTENT TYPE: {}".format(node, contenttype)
            )
    ...
    print(
        "Stored and retrieved %d of %d pairs (%.1f%%)"
...
def retrieve_from_different_nodes(nodes):
    ...
    for key, value in pairs.items():
        ...
        try:
            ...
            print(
                "PUT/GET to {} / {}: EXCEPTION DURING PUT: {}".format(
                    put_node, get_node, e
                )
            )
            continue
        try:
            ...
            print(
                "PUT/GET to {} / {}: EXCEPTION DURING GET: {}".format(
                    put_node, get_node, e
                )
            )
            continue
        ...
        if status in range(200, 300) and returned == value:
            ...
            print(
                "PUT/GET to {} / {}: UNEXPECTED CONTENT TYPE: {}".format(
                    put_node, get_node, contenttype
                )
            )
        elif status in range(200, 300) and returned != value:
            ...
            print(
                "PUT/GET to {} / {}: GET STATUS {}".format(put_node, get_node, status)
            )
